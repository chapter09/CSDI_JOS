...
libmain(int argc, char **argv)
{
  ...
  800052:	e8 cc 00 00 00       	call   800123 <sys_getenvid>
...
exit(void)
{
  ...
  80009d:	e8 03 01 00 00       	call   8001a5 <sys_env_destroy>
}
  8000a2:	c9                   	leave  
  8000a3:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000c5:	56                   	push   %esi
  8000c6:	57                   	push   %edi
  8000c7:	8d 35 d1 00 80 00    	lea    0x8000d1,%esi
  8000cd:	54                   	push   %esp
  8000ce:	5d                   	pop    %ebp
...
sys_cputs(const char *s, size_t len)
{
  ...
  8000db:	8b 7c 24 04          	mov    0x4(%esp),%edi
...
sys_cgetc(void)
{
  ...
  8000ec:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800105:	56                   	push   %esi
  800106:	57                   	push   %edi
  800107:	8d 35 11 01 80 00    	lea    0x800111,%esi
  80010d:	54                   	push   %esp
  80010e:	5d                   	pop    %ebp
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800145:	56                   	push   %esi
  800146:	57                   	push   %edi
  800147:	8d 35 51 01 80 00    	lea    0x800151,%esi
  80014d:	54                   	push   %esp
  80014e:	5d                   	pop    %ebp
  80014f:	0f 34                	sysenter 
  800151:	5f                   	pop    %edi
  800152:	5e                   	pop    %esi
  800153:	5d                   	pop    %ebp
  800154:	5c                   	pop    %esp
...
sys_getenvid(void)
{
  ...
  800158:	8b 1c 24             	mov    (%esp),%ebx
  80015b:	8b 7c 24 04          	mov    0x4(%esp),%edi
  80015f:	89 ec                	mov    %ebp,%esp
  800161:	5d                   	pop    %ebp
  800162:	c3                   	ret    

00800163 <sys_map_kernel_page>:
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  800169:	89 1c 24             	mov    %ebx,(%esp)
  80016c:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800187:	56                   	push   %esi
  800188:	57                   	push   %edi
  800189:	8d 35 93 01 80 00    	lea    0x800193,%esi
  80018f:	54                   	push   %esp
  800190:	5d                   	pop    %ebp
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  80019a:	8b 1c 24             	mov    (%esp),%ebx
  80019d:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8001a1:	89 ec                	mov    %ebp,%esp
  8001a3:	5d                   	pop    %ebp
  8001a4:	c3                   	ret    

008001a5 <sys_env_destroy>:
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
}
...
sys_env_destroy(envid_t envid)
{
  ...
  8001a8:	83 ec 28             	sub    $0x28,%esp
  8001ab:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8001ae:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8001b6:	b8 03 00 00 00       	mov    $0x3,%eax
  8001bb:	8b 55 08             	mov    0x8(%ebp),%edx
  8001be:	89 cb                	mov    %ecx,%ebx
  8001c0:	89 cf                	mov    %ecx,%edi
  8001c2:	51                   	push   %ecx
  8001c3:	52                   	push   %edx
  8001c4:	53                   	push   %ebx
  8001c5:	54                   	push   %esp
  ...
  8001c7:	56                   	push   %esi
  8001c8:	57                   	push   %edi
  8001c9:	8d 35 d3 01 80 00    	lea    0x8001d3,%esi
  8001cf:	54                   	push   %esp
  8001d0:	5d                   	pop    %ebp
  8001d1:	0f 34                	sysenter 
  8001d3:	5f                   	pop    %edi
  8001d4:	5e                   	pop    %esi
  8001d5:	5d                   	pop    %ebp
  8001d6:	5c                   	pop    %esp
  ...
  8001dc:	7e 28                	jle    800206 <sys_env_destroy+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001de:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001e2:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  8001e9:	00 
  8001ea:	c7 44 24 08 62 10 80 	movl   $0x801062,0x8(%esp)
  8001f1:	00 
  8001f2:	c7 44 24 04 29 00 00 	movl   $0x29,0x4(%esp)
  8001f9:	00 
  8001fa:	c7 04 24 7f 10 80 00 	movl   $0x80107f,(%esp)
  800201:	e8 0a 00 00 00       	call   800210 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  800206:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800209:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  800228:	c7 04 24 8d 10 80 00 	movl   $0x80108d,(%esp)
  80022f:	e8 ad 00 00 00       	call   8002e1 <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800234:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  80023a:	e8 e4 fe ff ff       	call   800123 <sys_getenvid>
  ...
  800255:	c7 04 24 94 10 80 00 	movl   $0x801094,(%esp)
  ...
  80026b:	e8 10 00 00 00       	call   800280 <vcprintf>
	cprintf("\n");
  800270:	c7 04 24 92 10 80 00 	movl   $0x801092,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8002bc:	e8 cc 01 00 00       	call   80048d <vprintfmt>
  ...
  8002d4:	e8 cb fd ff ff       	call   8000a4 <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  800328:	e8 77 fd ff ff       	call   8000a4 <sys_cputs>
		b->idx = 0;
