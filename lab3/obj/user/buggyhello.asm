...
libmain(int argc, char **argv)
{
  ...
  800062:	e8 cc 00 00 00       	call   800133 <sys_getenvid>
...
exit(void)
{
  ...
  8000ad:	e8 03 01 00 00       	call   8001b5 <sys_env_destroy>
}
  8000b2:	c9                   	leave  
  8000b3:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000d5:	56                   	push   %esi
  8000d6:	57                   	push   %edi
  8000d7:	8d 35 e1 00 80 00    	lea    0x8000e1,%esi
  8000dd:	54                   	push   %esp
  8000de:	5d                   	pop    %ebp
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800115:	56                   	push   %esi
  800116:	57                   	push   %edi
  800117:	8d 35 21 01 80 00    	lea    0x800121,%esi
  80011d:	54                   	push   %esp
  80011e:	5d                   	pop    %ebp
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800155:	56                   	push   %esi
  800156:	57                   	push   %edi
  800157:	8d 35 61 01 80 00    	lea    0x800161,%esi
  80015d:	54                   	push   %esp
  80015e:	5d                   	pop    %ebp
  80015f:	0f 34                	sysenter 
  800161:	5f                   	pop    %edi
  800162:	5e                   	pop    %esi
  800163:	5d                   	pop    %ebp
  800164:	5c                   	pop    %esp
...
sys_getenvid(void)
{
  ...
  80016b:	8b 7c 24 04          	mov    0x4(%esp),%edi
  80016f:	89 ec                	mov    %ebp,%esp
  800171:	5d                   	pop    %ebp
  800172:	c3                   	ret    

00800173 <sys_map_kernel_page>:
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  80017c:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800197:	56                   	push   %esi
  800198:	57                   	push   %edi
  800199:	8d 35 a3 01 80 00    	lea    0x8001a3,%esi
  80019f:	54                   	push   %esp
  8001a0:	5d                   	pop    %ebp
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  8001ad:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8001b1:	89 ec                	mov    %ebp,%esp
  8001b3:	5d                   	pop    %ebp
  8001b4:	c3                   	ret    

008001b5 <sys_env_destroy>:
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
}
...
sys_env_destroy(envid_t envid)
{
  ...
  8001bb:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8001be:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8001c6:	b8 03 00 00 00       	mov    $0x3,%eax
  ...
  8001d7:	56                   	push   %esi
  8001d8:	57                   	push   %edi
  8001d9:	8d 35 e3 01 80 00    	lea    0x8001e3,%esi
  8001df:	54                   	push   %esp
  8001e0:	5d                   	pop    %ebp
  8001e1:	0f 34                	sysenter 
  8001e3:	5f                   	pop    %edi
  8001e4:	5e                   	pop    %esi
  8001e5:	5d                   	pop    %ebp
  8001e6:	5c                   	pop    %esp
  ...
  8001ec:	7e 28                	jle    800216 <sys_env_destroy+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  8001ee:	89 44 24 10          	mov    %eax,0x10(%esp)
  8001f2:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  8001f9:	00 
  8001fa:	c7 44 24 08 72 10 80 	movl   $0x801072,0x8(%esp)
  800201:	00 
  800202:	c7 44 24 04 29 00 00 	movl   $0x29,0x4(%esp)
  800209:	00 
  80020a:	c7 04 24 8f 10 80 00 	movl   $0x80108f,(%esp)
  800211:	e8 0a 00 00 00       	call   800220 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  800216:	8b 5d f8             	mov    -0x8(%ebp),%ebx
...
_panic(const char *file, int line, const char *fmt, ...)
  800228:	8d 75 14             	lea    0x14(%ebp),%esi
	...
	if (argv0)
  80022b:	a1 08 20 80 00       	mov    0x802008,%eax
  800230:	85 c0                	test   %eax,%eax
  800232:	74 10                	je     800244 <_panic+0x24>
		cprintf("%s: ", argv0);
  800234:	89 44 24 04          	mov    %eax,0x4(%esp)
  800238:	c7 04 24 9d 10 80 00 	movl   $0x80109d,(%esp)
  80023f:	e8 ad 00 00 00       	call   8002f1 <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800244:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  80024a:	e8 e4 fe ff ff       	call   800133 <sys_getenvid>
  80024f:	8b 55 0c             	mov    0xc(%ebp),%edx
  800252:	89 54 24 10          	mov    %edx,0x10(%esp)
  800256:	8b 55 08             	mov    0x8(%ebp),%edx
  800259:	89 54 24 0c          	mov    %edx,0xc(%esp)
  80025d:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800261:	89 44 24 04          	mov    %eax,0x4(%esp)
  800265:	c7 04 24 a4 10 80 00 	movl   $0x8010a4,(%esp)
  80026c:	e8 80 00 00 00       	call   8002f1 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800271:	89 74 24 04          	mov    %esi,0x4(%esp)
  800275:	8b 45 10             	mov    0x10(%ebp),%eax
  800278:	89 04 24             	mov    %eax,(%esp)
  80027b:	e8 10 00 00 00       	call   800290 <vcprintf>
	cprintf("\n");
  800280:	c7 04 24 a2 10 80 00 	movl   $0x8010a2,(%esp)
  800287:	e8 65 00 00 00       	call   8002f1 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  80028c:	cc                   	int3   
  80028d:	eb fd                	jmp    80028c <_panic+0x6c>
	...
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800293:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;
  ...
  8002c5:	c7 04 24 0b 03 80 00 	movl   $0x80030b,(%esp)
  8002cc:	e8 cc 01 00 00       	call   80049d <vprintfmt>
	sys_cputs(b.buf, b.idx);
  8002d1:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  8002d7:	89 44 24 04          	mov    %eax,0x4(%esp)
  8002db:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  8002e1:	89 04 24             	mov    %eax,(%esp)
  8002e4:	e8 cb fd ff ff       	call   8000b4 <sys_cputs>
  ...
  8002f7:	8d 45 0c             	lea    0xc(%ebp),%eax
{
  ...
  800304:	e8 87 ff ff ff       	call   800290 <vcprintf>
	va_end(ap);
...
putch(int ch, struct printbuf *b)
{
  ...
  800312:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  800315:	8b 03                	mov    (%ebx),%eax
  800317:	8b 55 08             	mov    0x8(%ebp),%edx
  80031a:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  80031e:	83 c0 01             	add    $0x1,%eax
  ...
  800338:	e8 77 fd ff ff       	call   8000b4 <sys_cputs>
		b->idx = 0;
