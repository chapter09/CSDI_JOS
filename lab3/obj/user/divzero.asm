...
libmain(int argc, char **argv)
{
  ...
  80007a:	e8 3c 0c 00 00       	call   800cbb <sys_getenvid>
  80007f:	25 ff 03 00 00       	and    $0x3ff,%eax
  800084:	6b c0 64             	imul   $0x64,%eax,%eax
...
exit(void)
{
  ...
  8000c5:	e8 73 0c 00 00       	call   800d3d <sys_env_destroy>
}
  8000ca:	c9                   	leave  
  8000cb:	c3                   	ret    
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800271:	0f be 80 a0 10 80 00 	movsbl 0x8010a0(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80035a:	ff 24 95 ac 11 80 00 	jmp    *0x8011ac(,%edx,4)
  ...
  800454:	c7 44 24 08 ba 10 80 	movl   $0x8010ba,0x8(%esp)
  80045b:	00 
  ...
  800490:	c7 45 cc bd 10 80 00 	movl   $0x8010bd,-0x34(%ebp)
				p = "(null)";
			if (width > 0 && padc != '-')
...
getint(va_list *ap, int lflag)
{
  ...
  8006cc:	bb 31 11 80 00       	mov    $0x801131,%ebx
  ...
  8006f9:	bb 69 11 80 00       	mov    $0x801169,%ebx
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800d81:	00 
  800d82:	c7 44 24 08 20 13 80 	movl   $0x801320,0x8(%esp)
  800d89:	00 
  800d8a:	c7 44 24 04 29 00 00 	movl   $0x29,0x4(%esp)
  800d91:	00 
  800d92:	c7 04 24 3d 13 80 00 	movl   $0x80133d,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  800db0:	8d 75 14             	lea    0x14(%ebp),%esi
	...
	if (argv0)
  800db3:	a1 0c 20 80 00       	mov    0x80200c,%eax
  800db8:	85 c0                	test   %eax,%eax
  800dba:	74 10                	je     800dcc <_panic+0x24>
		cprintf("%s: ", argv0);
  800dbc:	89 44 24 04          	mov    %eax,0x4(%esp)
  800dc0:	c7 04 24 4b 13 80 00 	movl   $0x80134b,(%esp)
  800dc7:	e8 61 f3 ff ff       	call   80012d <cprintf>
  ...
  800ded:	c7 04 24 50 13 80 00 	movl   $0x801350,(%esp)
  800df4:	e8 34 f3 ff ff       	call   80012d <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800df9:	89 74 24 04          	mov    %esi,0x4(%esp)
  800dfd:	8b 45 10             	mov    0x10(%ebp),%eax
  800e00:	89 04 24             	mov    %eax,(%esp)
  800e03:	e8 c4 f2 ff ff       	call   8000cc <vcprintf>
	cprintf("\n");
  800e08:	c7 04 24 94 10 80 00 	movl   $0x801094,(%esp)
  800e0f:	e8 19 f3 ff ff       	call   80012d <cprintf>
