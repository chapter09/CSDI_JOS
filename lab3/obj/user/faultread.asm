	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800261:	0f be 80 a0 10 80 00 	movsbl 0x8010a0(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80034a:	ff 24 95 ac 11 80 00 	jmp    *0x8011ac(,%edx,4)
  ...
  800444:	c7 44 24 08 ba 10 80 	movl   $0x8010ba,0x8(%esp)
  80044b:	00 
  ...
  800480:	c7 45 cc bd 10 80 00 	movl   $0x8010bd,-0x34(%ebp)
				p = "(null)";
			if (width > 0 && padc != '-')
...
getint(va_list *ap, int lflag)
{
  ...
  8006bc:	bb 31 11 80 00       	mov    $0x801131,%ebx
  ...
  8006e9:	bb 69 11 80 00       	mov    $0x801169,%ebx
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800d71:	00 
  800d72:	c7 44 24 08 20 13 80 	movl   $0x801320,0x8(%esp)
  800d79:	00 
  800d7a:	c7 44 24 04 29 00 00 	movl   $0x29,0x4(%esp)
  800d81:	00 
  800d82:	c7 04 24 3d 13 80 00 	movl   $0x80133d,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  800db0:	c7 04 24 4b 13 80 00 	movl   $0x80134b,(%esp)
  ...
  800ddd:	c7 04 24 50 13 80 00 	movl   $0x801350,(%esp)
  ...
  800df3:	e8 c0 f2 ff ff       	call   8000b8 <vcprintf>
	cprintf("\n");
  800df8:	c7 04 24 94 10 80 00 	movl   $0x801094,(%esp)
